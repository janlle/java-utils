...
import com.leone.util.common.PropUtil;
import com.leone.util.jdbc.callback.DbCallBack;
import com.leone.util.jdbc.entity.Column;
import com.leone.util.jdbc.entity.PrimaryKey;
import com.leone.util.jdbc.entity.Table;
...
public class DbUtil {
    ...
    public static String getCamelCase(String name, boolean flag) {
        ...
        if (name != null) {
            String[] arr = StringUtils.split(name, Constants.UNDERLINE);
